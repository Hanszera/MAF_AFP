...
from torch.nn import Module, Identity, Linear,GELU
...
class EsmcClassifier(ESMC, PyTorchModelHubMixin):
    ...
    ESM_PRETRAINED_CHECKPOINT_PATHS = {
        "esmc_600m": "/weights/esmc_600m_2024_12_v0.pth",
    }

    AVAILABLE_CLASSIFIER_HIDDEN_RATIOS = {1, 2, 4}

    @classmethod
    def from_pretrained(cls, *args, **kwargs) -> "EsmcClassifier":
        """
    ...
    def forward(
            self, sequence_tokens: Tensor,text_tokens: list, sequence_id: Tensor | None = None
    ) -> Tensor:
...
class MLPClassifier(Module):
    ...
    def __init__(self, embedding_dimensions: int, hidden_ratio: int, num_classes: int):
        ...
        self.linear1 = Linear(embedding_dimensions, hidden_dimensions)
